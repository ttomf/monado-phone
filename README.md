...
**Tools used**: DeepSeek V4 Flash, opencode

**Extent of use**: AI was used to generate low-level boilerplate code and setup modules, primarily for Vulkan management, rendering setup and Android app. I rewrote the AI-generated code line by line and optimized it. This README was not generated by AI.

**Human Ownership**: All high-level architecture, project structure, and core application logic were designed and directed by me. All AI-generated code was thoroughly reviewed, tested, and integrated manually.
